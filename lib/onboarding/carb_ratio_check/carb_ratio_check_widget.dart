...
import 'carb_ratio_check_model.dart';
export 'carb_ratio_check_model.dart';

class CarbRatioCheckWidget extends StatefulWidget {
  const CarbRatioCheckWidget({
    Key? key,
    this.userRef,
  }) : super(key: key);
  ...
  @override
  _CarbRatioCheckWidgetState createState() => _CarbRatioCheckWidgetState();
}

class _CarbRatioCheckWidgetState extends State<CarbRatioCheckWidget> {
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: TextFormField(
                                            ...
                                            focusNode:
                                                _model.carbRatioFocusNode,
                                            autofocus: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              labelText: 'per grams carbs',
                                              hintStyle:
