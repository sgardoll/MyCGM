                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: StreamBuilder<
                                                                          LookupRecord>(
                                                                        stream:
                                                                            LookupRecord.getDocument(_model.recentlyScanned!),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          ...
                                                                          return InkWell(
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              context.pushNamed(
                                                                                ...
                                                                                queryParameters: {
                                                                                  'code': serializeParam(
                                                                                    itemLookupRecord.code,
                                                                                    ParamType.String,
                                                                                  ),
                                                                                  'imageUrl': serializeParam(
                                                                                    valueOrDefault<String>(
                                                                                      OpenFoodFactsApiStruct.maybeFromMap(itemLookupRecord.openFoodFacts.toMap())?.imageUrl,
                                                                                      'https://connectio.com.au/nutri/error.png',
                                                                                    ),
                                                                                    ParamType.String,
                                                                                  ),
                                                                                }.withoutNulls,
                                                                                        ...
                                                                                        updateDayPeriodStruct(
                                                                                          DayPeriodStruct(
                                                                                            ...
                                                                                            foodRef: FoodRefStruct(
                                                                                              foodLookupRef: itemLookupRecord.reference,
                                                                                            ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: ItemWidget(
                                                                                ...
                                                                                title: itemLookupRecord.name,
                                                                                subtitle: itemLookupRecord.brand,
                                                                                size: valueOrDefault<String>(
                                                                                  itemLookupRecord.size,
                                                                                  '-',
                                                                                ),
                                                                                blurHash: valueOrDefault<String>(
                                                                                  itemLookupRecord.blurHash,
                                                                                  'L9SF;Lay~qof%Mj[M{ay_3j[D%fQ',
                                                                                ),
                                                                                isDetailsPage: false,
                                                                                docRef: itemLookupRecord.reference,
                                                                              ),
                                                                            ),
                                                                          );
                                                                        },
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      imageUrl: listViewLookupRecord
                                                                          .openFoodFacts
                                                                          .imageUrl,
                                                                      title: listViewLookupRecord
                                                                          .name,
                                                                      subtitle:
                                                                          listViewLookupRecord
                                                                              .brand,
                                                                      size: listViewLookupRecord
                                                                          .size,
                                                                      blurHash:
                                                                          listViewLookupRecord
                                                                              .blurHash,
